...
class AgentSpec:
    ...
    does not act on; the exceptions are the advertised task capabilities and
    generic accepted/required context fields, which Hub reads to filter and
    enrich dispatches without specialist-specific branches.
